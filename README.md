...
The MDT currently supports English (EN), French (FR), and German (DE).
...
MDT scores are given on an [item response theory](https://en.wikipedia.org/wiki/Item_response_theory) metric.
These scores are similar to *z*-scores: 
an average score is about 0, and the typical standard deviation is around 1.
See [Harrison et al. (2017)](https://doi.org/10.1038/s41598-017-03586-z) for more precise benchmarks.
